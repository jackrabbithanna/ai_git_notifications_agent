...
- `accounts(id, forge[github|gitlab], login, host, write_mode[readonly|notifications] DEFAULT 'readonly', token_scopes, created_at)` — PAT in keyring `ghinbox/account:<id>`.
